package ma.mundiapolis.Thymeleaf.repository; // Dossier où se trouve le repository

import ma.mundiapolis.Thymeleaf.entities.Product; // J'utilise l'entité Product
